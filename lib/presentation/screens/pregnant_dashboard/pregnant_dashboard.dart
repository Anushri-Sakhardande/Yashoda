...
import '../community_chat/group_chat_screen.dart'; // ✅ Community chat screen
              ...
              builder: (context, snapshot) {
                ...
                return Center(
                  child: HealthStatusCircle(
                    ...
                    centerText: "${userProfile["pregnancyWeeks"]} Weeks of Pregnancy",
                  ),
                );
              },
            ),
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => GroupChatScreen(groupName: "pregnant"),
                        ),
                      );
                    },
